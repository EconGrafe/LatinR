...
# Data Pobreza
data_pobreza <- read_excel('C:/Users/Zadquiel/Documents/GitHub/LatinR/data_pobreza.xlsx') %>% clean_names()

# Data Parroquias
parr <- st_read('C:/Users/Zadquiel/Documents/GitHub/LatinR/map/Parroquias_Venezuela.shp') %>%
...
# Data Municipios
munven <- st_read('C:/Users/Zadquiel/Documents/GitHub/LatinR/map/Municipios_Venezuela.shp') %>%
